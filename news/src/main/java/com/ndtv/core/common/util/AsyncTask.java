...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final BlockingQueue<Runnable> sPoolWorkQueue = new LinkedBlockingQueue<Runnable>(5);
    ...
    public static volatile ExecutorService sDefaultExecutorService = Executors.newFixedThreadPool(CORE_POOL_SIZE,
            sThreadFactory);
    ...
    public ExecutorService getExecutorService() {
        if (sDefaultExecutorService == null) {
            sDefaultExecutorService = Executors.newCachedThreadPool(sThreadFactory);
        } else if (sDefaultExecutorService != null && sDefaultExecutorService.isShutdown()) {
            sDefaultExecutorService = Executors.newCachedThreadPool(sThreadFactory);
        }
    ...
    public final AsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(getExecutorService(), params);
    }
