 ...
 * @author Harisha B
 */
public class ShareAdapterNew extends ArrayAdapter<ShareApp> {
     ...
     * @param objects
     */
    public ShareAdapterNew(Context context, List<ShareApp> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflator.inflate(R.layout.share_pop_up_item_new, parent, false);
