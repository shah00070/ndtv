...
public class BitmapCache implements ImageLoader.ImageCache {
     ...
     *                        fragment.
     * @param fragmentTag     The tag of the retained fragment (should be unique for each
    ...
    public synchronized static BitmapCache getInstance(FragmentManager fragmentManager, int memCacheSize) {
        return getInstance(fragmentManager, TAG, memCacheSize);
    }

    public synchronized static BitmapCache getInstance(FragmentManager fragmentManager, float memCachePercent) {
        return getInstance(fragmentManager, calculateMemCacheSize(memCachePercent));
    }

    public synchronized static BitmapCache getInstance(FragmentManager fragmentManger) {
