...
// but first we check if we are waiting for the previous load to finish.
    ...
    /*
    We have to check for the scrollSate to ensure its the user is scrolling.
    For more infor, visit http://stackoverflow.com/questions/16073368/onscroll-gets-called-when-i-set-lv-onscrolllistnerthis-but-without-any-touch
     */
    @Override
